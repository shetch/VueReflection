  ...
  <section>
    <div class="container" v-show="showCategories">
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-2 text-center cards" v-for="category in categories">
              <router-link class="" v-bind:to="'/meals/'+category.strCategory.toLowerCase()">
              <div class="card mb-4">
                <div class="card-body">
